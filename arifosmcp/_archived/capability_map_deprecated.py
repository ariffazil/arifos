# ═══════════════════════════════════════════════════════════════════════════════
# DEPRECATED — ARCHIVED 2026-05-05
# ═══════════════════════════════════════════════════════════════════════════════
#
# This file mirrored the root capability_map.py with legacy arifos.* aliases.
# It is superseded by arifosmcp/constitutional_map.py which is the SOLE
# source of truth for the 13 canonical arif_* tools.
#
# ACTIVE REGISTRY: arifosmcp/constitutional_map.py
# RUNTIME CAPABILITY: arifosmcp/runtime/capability_map.py (env-checker, keep)
#
# F1 Amanah — do not delete until zero active callers are confirmed.
# ═══════════════════════════════════════════════════════════════════════════════
