...
# ═══════════════════════════════════════════════════════════════════════════════
#
# This file is OBSOLETE. It defined the v2 10-tool "mega-surface" with
# legacy naming (void_000, anchor_111, explore_222, etc.).
#
# ACTIVE REGISTRY: arifosmcp/constitutional_map.py
# The canonical 13-tool surface uses arif_* naming (arif_session_init, etc.)
#
