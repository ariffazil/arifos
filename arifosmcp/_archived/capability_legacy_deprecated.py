...
# ═══════════════════════════════════════════════════════════════════════════════
#
# This file defined the old arifos.* dotted-alias naming convention.
# It is superseded by arif_* underscored naming in constitutional_map.py.
#
...
"""
arifos/capability_map.py --- Canonical Tool Registry & Capability Matrix
