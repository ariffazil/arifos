...
def deduct_thermodynamic_budget(session_id: str, cost_eV: float) -> None:
    """Shim for older API — maps cost_eV to token energy (proxy)."""
    # 1 eV is approx 1.6e-19 J, which is negligible compared to our budget scale.
    # We use a 1e-3 J default consumption per call for the shim.
...
__all__ = [
    ...
    "deduct_thermodynamic_budget",  # Added for compat
