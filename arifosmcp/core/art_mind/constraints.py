...
F_CONSTRAINTS: list[FConstraint] = [
    ...
    FConstraint("F2",  "TRUTH",     "confidence ≥ 0.99 for CLAIM, else PLAUSIBLE / ESTIMATE / HYPOTHESIS", True),
    ...
    FConstraint("F7",  "HUMILITY",  "confidence ≤ 0.99 — no fake certainty (cap in BeliefEngine)", True),
    FConstraint("F8",  "GENIUS",    "long-term intelligence preserved (no destructive shortcuts)", True),
