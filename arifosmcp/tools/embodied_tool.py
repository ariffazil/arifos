...
ARIFOS_TOOL_CHARTERS = {
    ...
    "wealth_flow_liquidity": ToolManifest(
        ...
        domain="WEALTH",
        description=("Ω-WEALTH-02: Flow — liquidity movement (cashflow, burn, runway, survival)."),
        risk_tier="T1",
        reversibility="reversible",
        blast_radius=BlastRadius.MEDIUM,
    ...
    "wealth_entropy_risk": ToolManifest(
        ...
        domain="WEALTH",
        description=("Ω-WEALTH-04: Entropy — uncertainty, dispersion, tail risk, disorder."),
        risk_tier="T1",
        reversibility="reversible",
        blast_radius=BlastRadius.MEDIUM,
    ...
    "wealth_energy_productivity": ToolManifest(
        ...
        domain="WEALTH",
        description=("Ω-WEALTH-05: Energy — output per input, productivity, capital efficiency."),
        risk_tier="T1",
        reversibility="reversible",
        blast_radius=BlastRadius.LOW,
        required_floors=["F02", "F08"],
    ...
    "wealth_time_discount": ToolManifest(
        ...
        domain="WEALTH",
        description=("Ω-WEALTH-06: Time — NPV, IRR, payback, compounding, decay."),
        risk_tier="T1",
        reversibility="reversible",
        blast_radius=BlastRadius.LOW,
        required_floors=["F02", "F08"],
    ...
    "wealth_inertia_leverage": ToolManifest(
        ...
        domain="WEALTH",
        description=("Ω-WEALTH-07: Inertia — resistance to change, leverage stress, fragility."),
        risk_tier="T2",
        reversibility="reversible",
        blast_radius=BlastRadius.MEDIUM,
        required_floors=["F01", "F04", "F05"],
    ...
    "wealth_field_macro": ToolManifest(
        ...
        domain="WEALTH",
        description=("Ω-WEALTH-08: Field — macro environment (rates, FX, energy, carbon, regime)."),
        risk_tier="T0",
        reversibility="reversible",
        blast_radius=BlastRadius.LOW,
    ...
    "wealth_signal_information": ToolManifest(
        ...
        domain="WEALTH",
        description=("Ω-WEALTH-09: Signal — information value, evidence quality, schema validity."),
        risk_tier="T1",
        reversibility="reversible",
        blast_radius=BlastRadius.LOW,
    ...
    "wealth_game_coordination": ToolManifest(
        ...
        domain="WEALTH",
        description=("Ω-WEALTH-10: Game — multi-agent incentives, bargaining, coordination."),
        risk_tier="T1",
        reversibility="reversible",
        blast_radius=BlastRadius.MEDIUM,
