"""arifos_wiki — DEPRECATED (replaced by arifos_wiki_tools.search.search_index).
...
warnings.warn(
    "arifos_wiki is deprecated. Use arifos_wiki_tools.search.search_index instead.",
    DeprecationWarning,
    stacklevel=2,
)


def arifos_wiki(*args, **kwargs):
