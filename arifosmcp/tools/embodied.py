...
ARIFOS_TOOL_CHARTERS = {
    "arif_init": ToolManifest(
        ...
        tool_name="arif_init",
        domain="AOS",
        description="Bind a governed constitutional session before any other arif_* call",
        risk_tier="T1",
        reversibility="reversible",
        blast_radius=BlastRadius.LOW,
        required_permissions=[],
        required_floors=["L01", "L11", "L12"],
    ...
    "arif_fetch": ToolManifest(
        ...
        blast_radius=BlastRadius.LOW,
        required_permissions=[],
        required_floors=["L02", "L03", "L05", "L12"],
    ...
    "arif_kernel_route": ToolManifest(
        ...
        required_floors=["L01", "L04", "L03", "L10"],
    ...
    "well_assess_homeostasis": ToolManifest(
        ...
        required_permissions=[],
        required_floors=["L05", "L06", "L09"],
        safe_compose_with=["well_assess_metabolism", "well_assess_livelihood"],
        cognitive_axis=CognitiveAxis.VITALITY,
        expose=True,
    ),
    "well_check_repair": ToolManifest(
        ...
        blast_radius=BlastRadius.MEDIUM,
        required_permissions=[],
        required_floors=["L01", "L04", "L08"],
        safe_compose_with=["well_assess_homeostasis", "well_assess_reliability"],
    ...
    "well_assess_reliability": ToolManifest(
        ...
        blast_radius=BlastRadius.MEDIUM,
        required_permissions=[],
        required_floors=["L04", "L08"],
        safe_compose_with=["well_check_repair"],
        cognitive_axis=CognitiveAxis.VITALITY,
        expose=True,
    ),
    ...
    "wealth_boundary_governance": ToolManifest(
        ...
        reversibility="reversible",
        blast_radius=BlastRadius.HIGH,
        required_floors=["L01", "L04", "L11", "L13"],
        cognitive_axis=CognitiveAxis.BOUNDARY,
        expose=False,
    ),
