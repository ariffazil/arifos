...
TOOL_DISCOVERY: dict[str, dict[str, Any]] = {
    ...
    "arif_init": {
        ...
        "aliases": ["arif_session_init", "arifos_init", "session_init", "start_session", "begin_session"],
    ...
    "arif_critique": {
        ...
        "keywords": ["critique", "ethical", "risk", "dignity", "impact", "sensitive", "irreversible"],
        "examples": [
    ...
    "arif_bridge_connect": {
        ...
        "aliases": ["arif_call_organ", "arif_direct_call", "bridge_connect", "call_tool", "arif_bridge"],
