"""
arifosmcp.intelligence/tools/manifold_adapter.py — Prompt Manifold Integration
...
Usage:
    ...
    from arifosmcp.intelligence.tools.manifold_adapter import ManifoldMCPAdapter
