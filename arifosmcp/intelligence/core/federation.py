"""
arifosmcp.intelligence/core/federation.py — Multi-Agent Health Coordination

Aggregates health signals from registered arifOS agents (arifosmcp.transport,
arifosmcp.intelligence sensors, external services) and produces a consolidated
