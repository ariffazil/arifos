...
from arifosmcp.abi.v1_0 import ApexJudgeRequest, ApexJudgeResponse
...
class _ApexJudgeTool(Tool):
    ...
    async def execute(self, payload: dict) -> dict:
        """Execute apex_judge."""
        from arifosmcp.runtime.megaTools.tool_03_apex_soul import apex_judge as apex_judge_fn
