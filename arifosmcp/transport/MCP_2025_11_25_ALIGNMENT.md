...
**Files Modified:**
- `arifosmcp.transport/server.py` — Updated header with protocol declaration
- `arifosmcp.transport/package.json` — Already had `"protocolVersion": "2025-11-25"`
- `arifosmcp.transport/README.md` — Already documented
...
**Files Modified:**
- `arifosmcp.transport/server.py` — Added TOOL_ANNOTATIONS registry
