...
class DeployGateRunner:
    ...
    async def _gate_c_floors(self):
        ...
        try:
            ...
            print(
                f"  {'✅' if status == GateStatus.PASS else '❌'} Floors: {p0_pass}/{p0_total} PASS"
            )
    ...
    async def _gate_d_substrate(self):
        ...
        try:
            ...
            print(
                f"  {'✅' if status == GateStatus.PASS else '❌'} Substrate: {healthy_count}/{total_count} HEALTHY"
            )
    ...
    async def _gate_e_e2e(self):
        ...
        try:
            ...
            print(
                f"  {'✅' if status == GateStatus.PASS else '⚠️'} E2E: {e2e_pass}/{e2e_total} PASS"
            )
...
async def main():
    ...
    runner = DeployGateRunner(transport_mode=args.transport, human_ratified=args.ratify)
