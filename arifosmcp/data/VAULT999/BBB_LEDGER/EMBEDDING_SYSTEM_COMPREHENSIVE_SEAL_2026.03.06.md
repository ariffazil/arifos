...
- **MCP Tool:** recall_memory (arifosmcp.runtime/server.py)
...
from arifosmcp.runtime.server import recall_memory
...
### Implementation Code
- `arifosmcp.intelligence/embeddings/__init__.py` — BGE embedding generation
- `scripts/arifos_rag.py` — ConstitutionalRAG class
- `scripts/embed_constitutional_corpus.py` — Indexing pipeline
- `arifosmcp.runtime/server.py` — recall_memory MCP tool
