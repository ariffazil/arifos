...
def create_agents_mcp() -> FastMCP:
    ...
    @mcp.tool(
        name="E03_memory",
        description="E03 Memory — MemoryContract store/retrieve",
        tags={"execution", "public"},
        annotations={"readOnlyHint": False, "openWorldHint": False},
    )
    def E03_memory(operation: str, memory: dict[str, Any], tier: str) -> dict[str, Any]:
        """Memory operations."""
        return _stub("E03", {"operation": operation, "memory": memory, "tier": tier})
