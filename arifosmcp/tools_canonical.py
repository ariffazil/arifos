...
TOOL_ALIAS_MAP: dict[str, tuple[str, str, dict]] = {
    ...
    "M_cross_evidence_synthesize": (
        "arifos_compute_civilization",
        "cross_evidence_synthesize",
        {},
    ),
