...
Internal provision is delegated to legacy `arifosmcp.transport` and `arifosmcp.intelligence` packages.

USAGE (CLI):
- Local stdio (Cursor/Claude): `python -m arifosmcp.runtime stdio`
- VPS HTTP (ChatGPT/External): `python -m arifosmcp.runtime http --port 8080`
- VPS SSE: `python -m arifosmcp.runtime sse`
...
import arifosmcp.transport as legacy
...
# BGE Embeddings Integration from arifosmcp.intelligence
try:
