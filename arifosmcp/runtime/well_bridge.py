...
def _compute_failure_flags(metrics: dict, hrv_velocity: float,
                            consent_reliability: float) -> list:
    flags = []
...
def get_biological_readiness(task_load: float = 0.5,
...
def inject_biological_context(governance_state: Dict[str, Any],
                              task_load: float = 0.5) -> Dict[str, Any]:
    """
...
async def anchor_well_to_vault(summary: str = "WELL Substrate Anchor",
