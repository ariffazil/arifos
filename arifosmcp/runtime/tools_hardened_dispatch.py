...
def _build_dispatch_map() -> dict[str, Callable[..., Awaitable[Any]]]:
    ...
    return {
        "arifos.init": _dispatch_init,
        "arifos.route": _dispatch_route,
        "arifos.judge": _dispatch_judge,
        "arifos.forge": _dispatch_forge,
        "arifos.sense": _dispatch_sense,
        "arifos.mind": _dispatch_mind,
        "arifos.memory": _dispatch_memory,
        "arifos.heart": _dispatch_heart,
