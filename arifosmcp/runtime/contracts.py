...
AAA_TOOL_STAGE_MAP = {
    ...
    "sense_reality": "111_OBSERVE",
    "reason_synthesis": "333_REASON",
    "critique_safety": "444_CRITIQUE",
    "route_execution": "555_ROUTE",
    "load_memory_context": "555m_MEMORY",
    "estimate_ops": "555_ROUTE",
    "judge_verdict": "888_JUDGE",
    "record_vault_entry": "999_SEAL",
    "execute_vps_task": "M-3_EXEC",
    # v2 underscored names (Canonical 13 Alignment)
    "arifos_init": "000_INIT",
    "arifos_vault": "999_SEAL",
    "arifos_sense": "111_OBSERVE",
    "arifos_heart": "444_CRITIQUE",
    "arifos_forge": "666_FORGE",
    "arifos_mind": "333_REASON",
    "arifos_judge": "888_JUDGE",
    "arifos_kernel": "555_ROUTE",
    "arifos_ops": "777_MEASURE",
    "arifos_memory": "555m_MEMORY",
    "arifos_fetch": None,
    "arifos_reply": None,
    "arifos_gateway": "666g_GATEWAY",
    "arif_ping": "PROBE",
    "arif_selftest": "PROBE",
    "arifos_health": "111_OBSERVE",
}
...
TRINITY_BY_TOOL = {
    ...
    "route_execution": "DELTA Δ",
    "load_memory_context": "DELTA Δ",
    "estimate_ops": "DELTA Δ",
    "judge_verdict": "PSI Ψ",
    "record_vault_entry": "PSI Ψ",
    "execute_vps_task": "DELTA Δ",
    # v2 underscored names (Canonical 13 Alignment)
    "arifos_init": "PSI Ψ",
    "arifos_vault": "PSI Ψ",
    ...
    "arifos_mind": "DELTA Δ",
    "arifos_judge": "PSI Ψ",
    "arifos_kernel": "DELTA Δ",
    "arifos_ops": "DELTA Δ",
    "arifos_memory": "DELTA Δ",
