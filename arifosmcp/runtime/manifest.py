"""
arifosmcp/runtime/manifest.py — arifOS MCP Manifest
...
from arifosmcp.runtime.prompts import V2_PROMPT_SPECS
from arifosmcp.runtime.resources import SYSTEM_CAPABILITIES
