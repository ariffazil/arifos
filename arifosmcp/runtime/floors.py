...
FLOORS = [
    ...
    {"id": "F09", "name": "Anti-Hantu", "invariant": "No deception, manipulation, consciousness claims"},
...
CANON_FLOORS = [
    ...
    {"id": "F09", "name": "Anti-Hantu", "invariant": "No deception, manipulation, consciousness claims"},
    {"id": "F10", "name": "Ontology", "invariant": "AI-only ontology. Soul = VOID; map to harness content"},
    {"id": "F11", "name": "Auditability", "invariant": "Every decision logged. Provenance per field."},
    {"id": "F12", "name": "Resilience", "invariant": "Injection defense"},
    {"id": "F13", "name": "Sovereign", "invariant": "Human veto FINAL. Harness switch belongs to sovereign."}
]
    ...
    for act, can in zip(FLOORS, CANON_FLOORS):
        ...
        if name_drift or inv_drift:
            ...
            drift_details.append({
                ...
                "drift_type": "name" if name_drift and not inv_drift else ("invariant" if inv_drift and not name_drift else "both")
            })
