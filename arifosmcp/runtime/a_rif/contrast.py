"""
arifosmcp/runtime/a_rif/contrast.py — Anomaly Detection
═════════════════════════════════════════════════════════════════
...
from arifosmcp.runtime.a_rif.engine import detect_contrast

__all__ = ["detect_contrast", "route_from_contrast"]
...
def route_from_contrast(new_claims: list[str], background_claims: list[str]) -> dict:
    ...
    score = detect_contrast(new_claims, background_claims)
