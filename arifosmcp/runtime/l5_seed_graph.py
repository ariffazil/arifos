...
TOOLS = {
    ...
    "arif_judge": {
        ...
        "owner": "888",
        "expiry": "never",
        "revocation_path": "F13_SOVEREIGN_OVERRIDE",
    },
    "arif_seal": {
        "type": "Tool",
        "domain": "governance",
        ...
        "owner": "999",
        "expiry": "never",
        "revocation_path": "NONE_IMMUTABLE",
    },
    "arif_observe": {
        "type": "Tool",
        "domain": "governance",
...
def seed_tools(dry_run: bool = False) -> int:
    ...
    for name, meta in TOOLS.items():
        ...
        params = {
            ...
            "scope": meta["scope"],
            "owner": meta["owner"],
            "expiry": meta.get("expiry", "canon"),
            "revocation_path": meta.get("revocation_path", "F13_SOVEREIGN"),
            "ts": ts,
        }
        if dry_run:
