...
def validate_claim_evidence(claim: Mapping[str, Any], *, require_for_nontrivial: bool = True) -> list[str]:
    violations: list[str] = []
    ...
    if evidence_state in {"UNVERIFIED", "HYPOTHETICAL"} and claim.get("human_review_required") is not True:
