...
class AgentCard(BaseModel):
    ...
    description: str = (
        "AI governance system with 13 constitutional floors (F1-F13). Provides constitutional review, task execution, and multi-agent coordination with thermodynamic governance."
    )
    ...
    authentication: dict[str, Any] = Field(
        default_factory=lambda: {"schemes": ["none", "api_key"], "credentials": None}
    )
