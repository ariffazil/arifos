...
> **Source:** `wiki/raw/ROADMAP.md` | Version: `2026.04.13-COCKPIT-VERIFIED`
...
| :--- | :--- | :--- | :--- | :--- | :--- |
| **D** | ChatGPT Decision Cockpit | Shipped | ~$40k | Low–Med | **LIVE** — `decide(query)` verified end-to-end |
...
### arifOS Decision Cockpit (First Real App — Shipped)
...
Key completions (as of 2026.04.13):

- **Decision Cockpit shipped** — first real ChatGPT Apps tool (`decide(query)`) verified end-to-end
- P0/P1 runtime stabilization — UI crashes fixed, sense parser hardened, sovereign identity binding repaired
