...
2. **Email** — Use GitHub Security Advisory (private vulnerability reporting) or contact via the canonical project domain with subject: `[GEOX SECURITY] <brief description>`
