...
class TestAgiReason:
    ...
    async def test_agi_reason_basic(self):
        ...
        with patch(
            ...
            result = await agi_reason(query="Test reasoning query")
...
class TestAgiReflect:
    ...
    async def test_agi_reflect_basic(self):
        ...
        with patch(
            ...
            result = await agi_reflect(topic="Test topic")
...
class TestAsiCritique:
    ...
    async def test_asi_critique_basic(self):
        ...
        with patch(
            ...
            result = await asi_critique(draft_output="Test draft output")
    ...
    async def test_asi_simulate_basic(self):
        ...
        with patch(
            ...
            mock_envelope.model_dump.return_value = {
                "ok": True,
                "tool": "asi_simulate",
                "stage": Stage.HEART_666.value,
                "verdict": Verdict.SEAL.value,
            }
            mock_wrap.return_value = mock_envelope

            result = await asi_simulate(scenario="Test scenario")
...
class TestForge:
    ...
    async def test_forge_basic(self):
        ...
        with patch(
            ...
            result = await forge(spec="Create a test artifact")
    ...
    async def test_forge_with_risk_tier(self):
        ...
        with patch(
            ...
            result = await forge(spec="High risk operation", risk_tier="high")
...
class TestApexJudge:
    ...
    async def test_apex_judge_basic(self):
        ...
        with patch(
            ...
            result = await apex_judge(candidate_output="Test output to judge")
...
class TestVaultSeal:
    ...
    async def test_vault_seal_basic(self):
        ...
        with patch(
            ...
            result = await vault_seal(verdict="SEAL", evidence="Evidence for sealing")
...
class TestRealityTools:
    ...
    async def test_search_reality(self):
        ...
        with patch(
            ...
            result = await search_reality(query="Search query")
...
class TestAgentZeroTools:
    ...
    async def test_agentzero_engineer(self):
        ...
        with patch(
            ...
            result = await agentzero_engineer(task_description="Write code")
    ...
    async def test_agentzero_validate(self):
        ...
        with patch(
            ...
            result = await agentzero_validate(input_to_validate="Test input")
