...
replacements = {
    ...
    '@mcp.tool(name="apex_verdict", description="777–888_APEX — Forge + audit final verdict.")': '@mcp.tool(name="judge_soul", description="[Lane: Ψ Psi] [Floors: F1-F13] Sovereign verdict synthesis.")',
    "apex_verdict = ToolHandle(_apex_verdict)": "judge_soul = ToolHandle(_apex_verdict)",
    '@mcp.tool(name="sovereign_actuator", description="888_FORGE — Sandboxed execution of physical state mutations.")': '@mcp.tool(name="forge_hand", description="[Lane: Ψ Psi] [Floors: F1, F11, F12] Sandboxed action execution.")',
    "sovereign_actuator = ToolHandle(_sovereign_actuator)": "forge_hand = ToolHandle(_sovereign_actuator)",
