...
- [x] **→ Part 1.0: Constitutional Overview (Preamble)**
...
- [x] **→ Part 1.1: The ΔΩΨ Trinity Equation**
...
- [x] **→ Part 1.2: Thermodynamic Cooling Law**
...
- [x] **→ Part 6.2.1: Phoenix-72 Cooling Protocol**
...
- [x] **→ Part 5.1: Ψ Vitality Formula (Mathematical Form)**
  - Line 1-50: Dual forms (product/quotient)
  - Line 51-100: Dual derivation proof
- [x] **→ Part 5.2: GENIUS (G) Formula**
  - Line 150-200: G = Δ · Ω · Ψ · E²
- [x] **→ Part 5.3: C_dark Formula**
...
- [x] **→ Part 3.0: AAA Trinity Overview**
...
- [x] **→ Part 3.1: ARIF (Δ Architect) — Cold Logic**
...
- [x] **→ Part 3.2: ADAM (Ω Auditor) — Warm Empathy**
...
- [x] **→ Part 3.4: @EYE Sentinel — Meta-Observer**
...
- [x] **→ Part 4.1: 000 VOID (Reset)**
  - Line 1-50: State reset logic
- [x] **→ Part 4.2: 111 SENSE (Parse Input)**
  - Line 60-110: Crisis detection, @PROMPT entry gate
- [x] **→ Part 4.3: 222 REFLECT (Context Recall)**
  - Line 120-170: Memory retrieval
- [x] **→ Part 4.4: 333 REASON (ΔS Computation)**
  - Line 180-230: Clarity gain measurement
- [x] **→ Part 4.5: 444 EVIDENCE (Fact-Checking)**
  - Line 240-290: Truth verification
- [x] **→ Part 4.6: 555 EMPATHIZE (κᵣ, Peace²)**
  - Line 300-350: Empathy scoring
- [x] **→ Part 4.7: 666 ALIGN (Tri-Witness)**
  - Line 360-410: Consensus convergence
- [x] **→ Part 4.8: 777 FORGE (Output Generation)**
  - Line 420-470: Constitutional text generation
- [x] **→ Part 4.9: 888 JUDGE (APEX Decision)**
  - Line 480-530: Verdict selection
- [x] **→ Part 4.10: 999 SEAL (Emission Gate)**
...
- [x] **→ Part 4.11: TEARFRAME Physics Runtime**
...
- [x] **→ Part 9.1: Spec Binding (Track B Authority)**
  - Line 1-80: How specs are loaded
  - Line 81-160: SHA-256 verification
- [x] **→ Part 9.2: Code Binding (Track C Implementation)**
  - Line 200-280: Code adherence to spec
- [x] **→ Part 9.3: Integrity Verification**
...
- [x] **→ Part 4.8.1: 777 FORGE Constitutional Generation**
...
- [x] **→ Part 3.6: W@W Federation (Multi-Organ Coordination)**
...
- [x] **→ Part 4.12: Why Semantic Reduction Enables F1-F9**
...
- [x] **→ Part 4.2.1: @PROMPT Entry Gate (111 SENSE)**
  - Line 1-80: Crisis detection at entry
- [x] **→ Part 4.10.1: @PROMPT Exit Gate (999 SEAL)**
...
- [x] **→ Part 4.10.2: 999 Emission Rules**
...
- [x] **→ Part 5.5: Lane-Aware Truth Thresholds**
...
- [x] **→ Part 5.2.1: G Threshold (≥0.80)**
  - Line 300-350: Why G≥0.80 ensures governed intelligence
- [x] **→ Part 5.3.1: C_dark Threshold (<0.30)**
...
- [x] **→ Part 6.2: BBB (Behavioral Baseline)**
...
- [x] **→ Part 6.2.2: Amendment Workflow**
...
- [x] **→ Part 6.4: ZKPC Governance Proof**
...
- [x] **→ Part 6.4.1: EUREKA Receipt Structure**
...
- [x] **→ Part 6.2.3: Ledger Integrity Verification**
...
- [x] **→ Part 7.1: Paradox Load (Φₚ) — Crown Equation**
...
- [x] **→ Part 6.3: CCC (Constitutional Consensus Core)**
...
- [x] **→ Part 8.3: SCARS (Lessons from Failures)**
...
- [x] All 37 canon files backed up to `archive/pre_v45.1_consolidation/`
- [x] SHA-256 manifest generated for current canon state
- [x] Git branch created: `canon-consolidation-v45.1`

### During Migration
- [x] Each file migration updates this checklist
- [x] Cross-references verified (no orphaned links)
- [x] Spec bindings updated in unified canon
- [x] Code references updated in unified canon

### Post-Migration Verification
- [x] Coverage = 100% (all boxes checked)
- [x] Run: `scripts/verify_canon_coverage.py`
- [x] Run: `scripts/verify_spec_binding.py`
- [x] Run: `pytest tests/test_canon_integrity.py`
- [x] Human review: No content loss
- [x] Human seal: `/gitseal APPROVE`
