...
### 🚀 [333_atlas](./333_atlas/)
- `001_AGI_DELTA_ARCHITECT_v46.md` - **AGI IDENTITY** (Mind)
- `010_ATLAS_333_CANONICAL_v46.md` - Atlas Spec (CANON)
- `040_TRUTH_F1_v46.md` - F1: Truth (🎯)
- `050_CLARITY_F2_v46.md` - F2: Clarity (🔍)

### ⚡ [444_align](./444_align/)
- `020_PEACE_F3_v46.md` - F3: Peace (☮️)

### 💝 [555_empathize](./555_empathize/)
- `020_EMPATHY_F4_v46.md` - F4: Empathy (💝)
- `040_COMMUNICATION_LAW_v45.md` - ASI Law

### 🌉 [666_bridge](./666_bridge/)
- `010_HUMILITY_F5_v46.md` - F5: Humility (📏)
...
- `001_APEX_PSI_JUDGE_v46.md` - **APEX IDENTITY** (Soul)
- `010_COMPASS_888_CANONICAL_v46.md` - Compass Spec (CANON)
- `030_AMANAH_F6_v46.md` - F6: Amanah (🤲)
- `040_TRI_WITNESS_F8_v46.md` - F8: Witness (👥)
- `050_ANTI_HANTU_F9_v46.md` - F9: Soul-Safe (👻)
- `060_SYMBOLIC_GUARD_F10_v46.md` - F10: Symbolic Guard (Zenith)
