...
REGISTRY = {
    ...
    "Horizon_2_Swarm": (
        ...
        "researchers",
        "advanced",
        "[Agent_Roles, Concept_Metabolic_Pipeline]",
    ),
    ...
    "ToolSpec_arifos_judge": (
        ...
        "engineers",
        "advanced",
        "[MCP_Tools, Concept_Governance_Enforcer]",
    ),
    # Synthesis
