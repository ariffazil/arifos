...
>
> **Runtime truth (what's running now):** verify the deployed surfaces before claiming health. As checked on **2026-04-17**, `mcp.arif-fazil.com/health` returns **200 with 22 tools** (11 canonical + 9 P_* oracles + 2 execution). `mcp.arif-fazil.com` is the canonical live endpoint.
...
READINESS:         100/100 (gateway operational — 22 tools live at mcp.arif-fazil.com)
...
> Last verified: **2026-04-17** — public web portals respond, but the MCP gateway is partially degraded.
...
| [mcp.arif-fazil.com/health](https://mcp.arif-fazil.com/health) | ⚠️ 502 | Health endpoint not currently serving healthy runtime |
| [mcp.arif-fazil.com/mcp](https://mcp.arif-fazil.com/mcp) | ⚠️ 502 | MCP transport not currently healthy from public edge |
...
> **Note:** As of 2026-04-17, the public MCP gateway's `/mcp` and `/health` endpoints return 502. The tool portal at `/tools` remains live. Verify the gateway is healthy before relying on it for production workloads.

```bash
# Current public health check (returns 502 as of 2026-04-17)
curl -i https://mcp.arif-fazil.com/health

# Tool portal (live as of 2026-04-17)
...
*Version: 2026.04.17 · Kernel: ΔΩΨ-ARIF-888 · Seal: SEAL_20260417_FINAL_CONSOLIDATION · Repo Status: CANONICAL / Public MCP Status: PARTIALLY DEGRADED (`/tools` live 200, `/health` and `/mcp` 502 on 2026-04-17)*
