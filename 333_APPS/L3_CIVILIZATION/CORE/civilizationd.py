...
from .town_square import TOPIC_JOB_AUDIT, TOPIC_JOB_NEWS, CivilizationBus
...
class ClockmakerDaemon:
    ...
    def trigger_audit(self):
        ...
        self.bus.publish_event(
            TOPIC_JOB_AUDIT,
            {"source": "clockmaker", "action": "trigger_apex_audit", "target": "soul_agent"},
        )
    ...
    def trigger_news_refresh(self):
        ...
        self.bus.publish_event(
            TOPIC_JOB_NEWS,
            {"source": "clockmaker", "action": "scrape_curated_feeds", "target": "mind_agent"},
        )
