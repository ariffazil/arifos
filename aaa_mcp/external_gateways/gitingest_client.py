"""
aaa_mcp/external_gateways/gitingest_client.py — Metabolic GitIngest Encoder
...
class GitingestClient:
    ...
    async def ingest(
        ...
        digest, tree, file_count = await self._run_gitingest(source, subpath, include_patterns, exclude_patterns)
