"""
arifos/runtime/tools_internal.py — FIXED VERSION
...
from arifos.runtime.schemas import IntentType
from arifos.runtime.sessions import (
    get_session_identity,
)
from arifos.tools.agentzero_tools import (
...
from arifos.runtime.sessions import _normalize_session_id
...
async def _wrap_call(
    ...
    try:
        ...
        from arifos.runtime.models import CanonicalMetrics, VerdictCode
...
async def agi_mind_dispatch_impl(
    ...
    if mode == "reason":
        ...
        if decision_packet:
            ...
            from arifos.contracts.artifacts import AnswerBasis, Claim
...
async def engineering_memory_dispatch_impl(
    ...
    if mode == "engineer":
        ...
        if store:
            try:
                from arifos.agentzero.memory.constitutional_memory import MemoryArea
...
async def architect_registry_dispatch_impl(
    ...
    if mode == "context":
        from arifos.capability_map import build_llm_context_map
        return RuntimeEnvelope(
            ok=True,
