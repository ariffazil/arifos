"""
arifos/runtime/manifest.py — arifOS MCP Manifest
...
from arifos.runtime.prompts import V2_PROMPT_SPECS
from arifos.runtime.resources import SYSTEM_CAPABILITIES
from arifos.runtime.tool_specs import V2_TOOLS
...
def build_manifest_v2(public_base_url: str = "https://arifosmcp.arif-fazil.com") -> dict[str, Any]:
    ...
    resources = [
        ...
        },
        {
            "uri": "arifos://vitals",
            "name": "arifOS Vitals",
            "description": "Real-time constitutional health and thermodynamics",
            "mimeType": "application/json",
        },
        {
            "uri": "arifos://schema",
            "name": "arifOS Schema",
            "description": "Complete structural blueprint: master schema, tools, Trinity, reply protocol",
            "mimeType": "application/json",
        },
        {
            "uri": "arifos://session/{session_id}",
            "name": "arifOS Session",
            "description": "Ephemeral per-session state and task dashboard",
            "mimeType": "application/json",
        },
        {
            "uri": "arifos://forge",
            "name": "arifOS Forge",
            "description": "Execution bridge and deployment topology",
            "mimeType": "application/json",
        },
    ]
