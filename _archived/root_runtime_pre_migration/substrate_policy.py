"""
arifos/runtime/substrate_policy.py — The Intelligence Mapping for AAA Wire
...
AAA_SUBSTRATE_POLICY = {
    ...
    "arifos.ops": {
        "estimate": ModePolicy(SubstrateClass.READ, RiskTier.LOW, "M-2_OPS", ["F8"], "Operational feasibility")
    }
}
