"""
arifos/runtime/tools.py — arifOS MCP Sovereign Core — 11 Canonical Tools
...
from arifos.integrations.memory_bridge import arifos_memory_query as arifos_memory
...
from arifos.runtime.megaTools import wealth_valuation as _mega_wealth
from arifos.runtime.models import RuntimeEnvelope, RuntimeStatus
from arifos.tools.fetch_tool import arifos_fetch
...
def _make_f12_block_envelope(
    ...
    from arifos.runtime.models import RuntimeStatus, Verdict
...
def _session_gate_envelope(
    ...
    *,
    ...
    from arifos.runtime.models import CanonicalAuthority, ClaimStatus, RiskClass
...
def _inject_session_snapshot(
    ...
    from arifos.runtime.models import ClaimStatus, RiskClass
...
async def arifos_init(
    ...
    # ── F12: Injection Guard ──────────────────────────────────────────────
    from arifos.runtime.webmcp.security import WebInjectionGuard
    ...
    if mode in (
        ...
        from arifos.runtime.kernel_runtime import get_kernel_runtime
        ...
        from arifos.runtime.arifos_runtime_envelope import RuntimeEnvelope
        from arifos.runtime.models import RuntimeStatus
    ...
    try:
        ...
        from arifos.runtime import vault_postgres
    ...
    if session_id and getattr(envelope, "session_id", None) != session_id:
        try:
            from arifos.runtime.sessions import bind_session_identity
...
async def arifos_sense(
    ...
    if mode == "governed":
        ...
        try:
            from arifos.runtime.sensing_protocol import (
                TimeScope,
                normalize_query,
            )
            from arifos.runtime.sensing_protocol import (
...
async def arifos_mind(
    ...
    """
    from arifos.runtime.sessions import _normalize_session_id, get_session_identity
    ...
    # ═══════════════════════════════════════════════════════════════════════
    from arifos.runtime.arifos_runtime_envelope import Provenance, run_agi_mind
...
async def _run_sequential_thinking(
    ...
    from arifos.runtime.models import RuntimeEnvelope as _RE
    from arifos.runtime.models import RuntimeStatus, Verdict
    from arifos.runtime.thinking import THINKING_TEMPLATES, ThinkingSessionManager
    from arifos.runtime.thinking.templates import auto_select_template
    ...
    if mode == "sequential":
        ...
        mem_context = ""
        try:
            from arifos.integrations.memory_bridge import arifos_memory_query
...
async def arifos_route(
    ...
    if getattr(envelope, "philosophy", None) is None:
        from arifos.runtime.philosophy_registry import inject_philosophy
...
async def arifos_heart(
    ...
    from arifos.runtime.arifos_runtime_envelope import heart_stage, mind_stage, sense_stage
...
async def arifos_memory(
    ...
    """
    from arifos.core.kernel.metabolic_bridge import metabolic_bridge
    ...
    if canonical_mode == "ingest":
        ...
        from arifos.runtime.models import RuntimeEnvelope as RE
        from arifos.runtime.models import ExecutionStatus, GovernanceStatus
...
async def arifos_health(
    ...
    from arifos.runtime.models import RuntimeEnvelope as RE
    from arifos.runtime.models import RuntimeStatus, UserModel, Verdict
...
from arifos.runtime.tools_forge import arifos_forge
...
async def arifos_reply(
    ...
    from arifos.runtime.models import RuntimeEnvelope as RE
    from arifos.runtime.models import RuntimeStatus
    from arifos.runtime.models import Verdict as V
...
async def arifos_diag_substrate(session_id: str | None = None) -> Any:
    ...
    from arifos.evals.everything_conformance_runner import run_protocol_conformance_test
...
async def _arifos_forge_public(
    ...
    platform: Annotated[str, "Deployment platform (mcp, stdio, etc.)"] = "unknown",
    plan_id: Annotated[str, "Canonical plan ID authorizing this forge"] = "",
) -> RuntimeEnvelope:
    session_ctx = _load_public_session_context(session_id)
    if session_ctx is None:
...
def _resolve_caller_context(
    ...
    from arifos.runtime.models import CallerContext, PersonaId
...
def register_v2_tools(mcp: FastMCP, *, include_legacy_compat: bool = False) -> list[str]:
    ...
    from arifos.runtime.tool_specs import PUBLIC_TOOL_SPECS
