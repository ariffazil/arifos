...
from arifos.runtime.belief_registry import update_belief
from arifos.runtime.governance_enforcer import (
    QueryClass,
    classify_and_route,
...
class HardenedKernelRouter:
    ...
    async def _invoke_tool_with_governance(
        ...
        from arifos.runtime.tools import CANONICAL_TOOL_HANDLERS, get_tool_handler
