...
async def search(query: str) -> dict[str, Any]:
    ...
    from arifos.runtime.megaTools.tool_08_physics_reality import physics_reality
...
async def fetch(id: str) -> dict[str, Any]:
    ...
    """
    # Lazy import to avoid circular dependencies at module load
    from arifos.runtime.megaTools.tool_07_engineering_memory import engineering_memory
