...
from arifos.runtime.build_info import get_build_info
from arifos.runtime.mcp_utils import call_mcp_tool
from arifos.runtime.optional_deps import aiofiles
        ...
        async with self._lock:
            ...
            if task.state in [TaskState.COMPLETED, TaskState.FAILED, TaskState.CANCELLED]:
                return CancelTaskResponse(
                    success=False, message=f"Task already in terminal state: {task.state}"
                )
    ...
    async def _execute_task(self, task_id: str):
        ...
        try:
            ...
            if verdict == "VOID":
                ...
                try:
                    from arifos.runtime.cross_protocol_bridge import HoldEvent, get_hold_bridge
                ...
                while True:
                    ...
                    if task.state != last_state:
                        ...
                        update = TaskStatusUpdate(
                            task_id=task_id, state=task.state, message=f"Task is now {task.state}"
                        )
