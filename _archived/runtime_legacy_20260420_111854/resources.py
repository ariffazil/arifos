"""
arifos/runtime/resources.py — arifOS MCP v2 Resources
...
def register_v2_resources(mcp: FastMCP) -> list[str]:
    ...
    from arifos.schema import get_registry
    try:
        from arifos.runtime.tools import CANONICAL_TOOL_HANDLERS
    ...
    async def get_vitals(format: str = "json", window: str = "live") -> ResourceResult:
        ...
        try:
            from arifos.runtime.vault_redis import get_vault_store
    ...
    async def get_session(
        ...
        from arifos.specs.tool_specs import CANONICAL_TOOL_SPECS
        authority_rank = {
            "anonymous": 0,
            "anchored": 1,
            "verified": 2,
