"""
arifos/runtime/ingress_middleware.py
...
from arifos.runtime.fastmcp_version import IS_FASTMCP_3

logger = logging.getLogger(__name__)

try:
    from arifos.runtime.metrics import METABOLIC_LOOP_DURATION, REQUESTS_TOTAL
