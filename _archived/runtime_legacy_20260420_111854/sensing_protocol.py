"""
arifos/runtime/sensing_protocol.py — Governed Sensing Protocol — 8-Stage Constitutional
═══════════════════════════════════════════════════════════════════════════════
...
from arifos.runtime.philosophy_registry import select_philosophy_state
...
class RealityHandlerSearchProvider:
    ...
    def _get_handler(self) -> Any:
        if self._handler is None:
            from arifos.runtime.reality_handlers import handler as _h
...
class SubstrateFetchProvider:
    ...
    async def search(
        ...
        from arifos.integrations.fetch_bridge import fetch_bridge
