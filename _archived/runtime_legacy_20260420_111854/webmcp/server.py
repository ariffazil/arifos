...
from arifos.runtime.optional_deps import redis
from arifos.runtime.public_registry import PUBLIC_TOOL_SPECS
...
class WebMCPGateway:
    ...
    Usage:
        from arifos.runtime.webmcp import WebMCPGateway
    ...
    def _setup_routes(self):
        ...
        async def resolve_hold(hold_id: str, request: Request):
            ...
            try:
                ...
                from arifos.runtime.cross_protocol_bridge import get_hold_bridge
...
def create_webmcp_app(mcp_server: Any) -> FastAPI:
    ...
    Usage:
        from arifos.runtime.webmcp import create_webmcp_app
