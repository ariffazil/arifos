"""
arifos_mcp/runtime/orchestrator.py — The arifOS Metabolic Loop Orchestrator
...
async def handle_pns_search(query: str, session_id: str) -> RuntimeEnvelope:
    ...
    from arifos_mcp.runtime.tools import reality_compass
...
async def handle_pns_health(session_id: str) -> RuntimeEnvelope:
    ...
    from arifos_mcp.runtime.tools import check_vital
...
async def handle_pns_orchestrate(task: str, session_id: str) -> RuntimeEnvelope:
    ...
    from arifos_mcp.tools.agentzero_tools import agentzero_engineer
...
async def handle_pns_floor(input_data: Any, session_id: str) -> RuntimeEnvelope:
    ...
    from arifos_mcp.runtime.tools import audit_rules
...
async def handle_pns_redteam(candidate: str, session_id: str) -> RuntimeEnvelope:
    ...
    from arifos_mcp.tools.agentzero_tools import agentzero_validate
...
async def run_stage(
    ...
    try:
        ...
        if stage_id == Stage.FORGE_777.value:
            from arifos_mcp.runtime.tools import agi_asi_forge_handler
...
async def metabolic_loop(
    ...
    **kwargs,
    ...
    if dry_run:
        from arifos_mcp.runtime.models import AuthContext
    ...
    try:
        ...
        from arifos_mcp.runtime.metrics import compute_integrity_telemetry
