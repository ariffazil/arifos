"""
arifos_mcp/runtime/tools_hardened_dispatch.py — Dispatcher for Hardened Tools
...
async def hardened_code_engine_dispatch(
    ...
    from arifos_mcp.runtime.shell_forge import forge
...
async def hardened_compat_probe_dispatch(
    ...
    from arifos_mcp.runtime.megaTools.tool_12_compat_probe import compat_probe
