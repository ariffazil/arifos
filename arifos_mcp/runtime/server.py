"""
arifos_mcp/runtime/server.py — arifOS AAA Sovereign Hub - HARDENED
...
try:
    ...
    from arifos_mcp.runtime.chatgpt_integration.chatgpt_tools import register_chatgpt_tools
...
def _attach_protocol_apps() -> None:
    ...
    try:
        from arifos_mcp.runtime.a2a import create_a2a_server
...
if __name__ == "__main__":
    from arifos_mcp.runtime.fastmcp_ext.transports import run_server
