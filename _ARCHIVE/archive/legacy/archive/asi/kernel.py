...
from .engine import ASIEngine, cleanup_expired_sessions, execute_asi, get_asi_engine
...
class ASINeuralCore:
    ...
    async def _execute_full(self, query: str, context: dict[str, Any]) -> dict[str, Any]:
        ...
        return {
            ...
            "stakeholders": (
                [s.name for s in omega_bundle.stakeholders] if omega_bundle.stakeholders else []
            ),
            "verdict": (
