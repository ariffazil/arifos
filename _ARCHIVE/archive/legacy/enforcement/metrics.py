...
VERDICTS_TOTAL = safe_counter(
    "arifos_verdicts_total", "Total constitutional verdicts issued", ["verdict"]
)

FLOOR_VIOLATIONS_TOTAL = safe_counter(
    "arifos_floor_violations_total", "Constitutional floor violations tracked by ID", ["floor"]
)
...
SEAL_RATE = safe_gauge(
    "arifos_seal_rate", "Rolling SEAL rate (success rate of constitutional audits)"
)
