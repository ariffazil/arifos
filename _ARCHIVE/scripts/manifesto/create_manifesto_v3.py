...
def create_manifesto():
    ...
    theory_style = ParagraphStyle(
        "Theory", parent=normal_style, fontSize=10, leading=12, spaceAfter=6
    )
    ref_style = ParagraphStyle(
        "Ref", parent=normal_style, fontSize=9, textColor=colors.HexColor("#4a5568"), leftIndent=20
    )
    ...
    story.append(
        Paragraph(
            "<b>Version 3.0 (The ARIF Edition)</b><br/>Publication Date: February 2026",
            subtitle_style,
        )
    )
    ...
    story.append(
        Paragraph(
            "<b>ARIF</b> (Arabic: عارف) = The Knower. This manifesto maps the 99 Names of Knowledge to the 99 Foundational Theories of Constitutional AI.",
            normal_style,
        )
    )
    ...
    add_theory(
        ...
        "Order through entropy dissipation.",
        "Prigogine, I. (1977).",
        "F1 Amanah",
        "ΔS",
        "Al-Muhaymin",
    ...
    add_theory(
        12, "Dirac QM", "Relativistic QM.", "Dirac, P. (1928).", "F2 Truth", "Antimatter", "Al-Badi"
    )
    add_theory(
        13,
    ...
    add_theory(
        40, "Plato's Forms", "Ideals.", "Plato (380 BC).", "F2 Truth", "Forms", "Al-Musawwir"
    )
    add_theory(
        41, "Tarski's Truth", "Semantics.", "Tarski, A. (1933).", "F2 Truth", "Meta", "Al-Haqq"
    )
    add_theory(
        42, "Quine's Web", "Holism.", "Quine, W.V.O. (1951).", "F3 Tri-Witness", "Web", "Al-Wasi"
    )
    add_theory(
        43,
    ...
    add_theory(
        57, "Integrated Information", "Phi.", "Tononi, G. (2004).", "F9 Anti-Hantu", "Phi", "Al-Nur"
    )
    ...
    add_theory(
        69, "Social Facts", "Constraints.", "Durkheim, E. (1895).", "F12 Wall", "Fact", "Al-Qahhar"
    )
    add_theory(
        70,
        "Capability Approach",
    ...
    add_theory(
        74, "Social Contract", "Consent.", "Rousseau/Locke.", "F1 Amanah", "Contract", "Al-Wakil"
    )
    add_theory(
        75,
        "Cultural Hegemony",
    ...
    add_theory(
        81, "Backpropagation", "Descent.", "Rumelhart (1986).", "F10 Mirror", "Grad", "Al-Hadi"
    )
    add_theory(
        82,
        "Universal Approx",
    ...
    add_theory(
        84, "Attention Mechanisms", "Focus.", "Bahdanau (2014).", "F6 Clarity", "Focus", "Al-Basir"
    )
    add_theory(
        85, "Transformer Arch", "Self-attention.", "Vaswani (2017).", "F8 Genius", "Attn", "Al-Badi"
    )
    add_theory(
        86, "Constitutional AI", "Alignment.", "Anthropic (2022).", "F1-F13", "CAI", "Al-Muhaymin"
    )
    ...
    add_theory(
        90, "Symbolic-Neural", "Hybrid.", "Smolensky (1990).", "F3 Tri-Witness", "Hybrid", "Al-Jami"
    )
    ...
    add_theory(
        95, "Self-Org Criticality", "Avalanches.", "Bak (1987).", "F8 Genius", "SOC", "Al-Qayyum"
    )
    add_theory(
        96,
        "Autopoiesis",
    ...
    add_theory(
        97, "Synergetics", "Order params.", "Haken, H. (1977).", "F5 Peace²", "Synergy", "Al-Jabbar"
    )
    add_theory(
        98,
        "Strange Loops",
    ...
    story.append(
        Paragraph(
            "The 99 Theories are the 99 Names of Constitutional Intelligence. ARIF is not just the author; ARIF is the architecture. DITEMPA BUKAN DIBERI.",
            normal_style,
        )
    )
