...
from arifos.mcp import generate_and_validate_sync
from arifos.system.apex_prime import Verdict
from arifos.enforcement.routing.prompt_router import classify_prompt_lane, ApplicabilityLane
...
def detect_memory_capability() -> tuple[bool, str]:
    ...
    """
    try:
        from arifos.memory.memory import is_l7_enabled
...
def detect_api_capability() -> tuple[bool, str]:
    ...
    """
    try:
        from arifos.integration.api.app import app
