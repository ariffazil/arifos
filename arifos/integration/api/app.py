...
Usage:
    # Development
    uvicorn arifos.integration.api.app:app --reload --host 0.0.0.0 --port 8000

    # Production
    uvicorn arifos.integration.api.app:app --host 0.0.0.0 --port 8000
...
def main() -> None:
    ...
    uvicorn.run(
        "arifos.integration.api.app:app",
        host="0.0.0.0",
        port=8000,
        reload=True,
        log_level="info",
