...
class GovernedPipeline:
  ...
  Usage (pseudo-code):
      from arifos.integration.wrappers.governed_session import GovernedPipeline
...
def configure_governed_pipeline(
  ...
  *,
  ...
  Example:
      from arifos.integration.wrappers.governed_session import configure_governed_pipeline, governed_answer
