...
Phase 1 goal:
    ...
    without modifying arifos.pipeline or APEX PRIME.

Usage (conceptual):

    from arifos.guards import DependencyGuard
    from arifos.integration.wrappers import GovernedSessionWrapper
