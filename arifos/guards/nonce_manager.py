...
Update your imports:
  OLD: from arifos.guards.nonce_manager import NonceManager
  NEW: from arifos.hypervisor.guards.nonce_manager import NonceManager
...
from arifos.hypervisor.guards.nonce_manager import *
