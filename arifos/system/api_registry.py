...
# =============================================================================
# TOP-LEVEL EXPORTS (from arifos import ...)
# =============================================================================
...
_REGISTRY.register(APIEntry(
    ...
    stability=StabilityLevel.STABLE,
    kind="class",
    module="arifos.system.runtime_manifest",
...
_REGISTRY.register(APIEntry(
    ...
    stability=StabilityLevel.STABLE,
    kind="constant",
    module="arifos.enforcement.metrics",
...
_REGISTRY.register(APIEntry(
    ...
    stability=StabilityLevel.STABLE,
    kind="constant",
    module="arifos.enforcement.genius_metrics",
...
# arifos.apex.governance
_REGISTRY.register(APIEntry(
    name="FAG",
    stability=StabilityLevel.STABLE,
    kind="class",
    module="arifos.apex.governance.fag",
...
_REGISTRY.register(APIEntry(
    ...
    stability=StabilityLevel.STABLE,
    kind="function",
    module="arifos.apex.governance.merkle",
...
_REGISTRY.register(APIEntry(
    ...
    stability=StabilityLevel.STABLE,
    kind="class",
    module="arifos.memory.eureka_receipt",
    description="EUREKA receipt",
))

# arifos.integration.waw
_REGISTRY.register(APIEntry(
    name="WAWFederation",
    stability=StabilityLevel.STABLE,
    kind="class",
    module="arifos.integration.waw.federation",
...
_REGISTRY.register(APIEntry(
    ...
    stability=StabilityLevel.STABLE,
    kind="class",
    module="arifos.integration.waw.well_file_care",
...
_REGISTRY.register(APIEntry(
    ...
    stability=StabilityLevel.BETA,
    kind="function",
    module="arifos.mcp.tools.recall",
...
_REGISTRY.register(APIEntry(
    ...
    stability=StabilityLevel.BETA,
    kind="function",
    module="arifos.mcp.tools.fag_read",
...
def check_module_stability(module_name: str, actual_all: List[str]) -> Dict:
    ...
    Args:
        module_name: Full module path (e.g., "arifos")
