...
USE INSTEAD: arifos.mcp.orthogonal_executor.OrthogonalExecutor
...
# v38 Stage Modules - v42: stages is at arifos/stages/
from arifos.enforcement.stages.stage_000_amanah import compute_amanah_score, stage_000_amanah
from arifos.enforcement.stages.stage_555_empathy import compute_kappa_r
from arifos.memory.l7.mem0_client import is_l7_enabled

# v38.2-alpha L7 Memory Layer (Mem0 + Qdrant)
from arifos.memory.core.memory import Memory, RecallResult, StoreAtSealResult
from arifos.memory.core.memory import recall_at_stage_111 as _l7_recall
from arifos.memory.core.memory import store_at_stage_999 as _l7_store

# v38 Runtime Contract Layer
from arifos.utils.runtime_types import Job, JobClass, Stakeholder
...
def _apply_apex_floors(
    ...
    """
    from arifos.system.apex_prime import ApexVerdict, Verdict, apex_review, check_floors
...
def _map_verdict_to_eureka(verdict: Optional["ApexVerdict"]) -> EurekaVerdict:
    ...
    from arifos.memory.eureka_types import Verdict as EurekaVerdict
...
def _write_memory_for_verdict(
    ...
    """
    from arifos.memory.audit import compute_evidence_hash
    from arifos.memory.bands import append_eureka_decision
    from arifos.memory.eureka_types import ActorRole, MemoryWriteRequest
    ...
    floor_checks = []
    if state.metrics is not None:
        from arifos.enforcement.metrics import _load_floors_spec_unified
...
def stage_888_judge(
    ...
    from arifos.memory.eureka_types import ActorRole
    from arifos.system.runtime.bootstrap import get_bootstrap_payload
    ...
    # ==========================================================================
    try:
        from arifos.enforcement.crisis_handler import detect_crisis, get_crisis_response
    ...
    # ==========================================================================
    try:
        from arifos.enforcement.crisis_handler import detect_anti_hantu_violation
...
def stage_999_seal(state: PipelineState) -> PipelineState:
    ...
    """
    from arifos.enforcement.sabar_timer import Sabar72Timer
...
class Pipeline:
    ...
    def __init__(
        ...
        """
        from arifos.system.engines import AGIEngine, ASIEngine
        from arifos.system.runtime.bootstrap import ensure_bootstrap
...
def main() -> int:  # pragma: no cover
    """CLI shim: `python -m arifos.system.pipeline --query \"...\"`."""
