...
Usage:
    from arifos.system.runtime_manifest import load_runtime_manifest, get_active_epoch
    ...
    from arifos.system.runtime_manifest import is_legacy_epoch
    if is_legacy_epoch():
...
# Base paths
# v42: File moved from arifos/ to arifos_core/system/, need to go up 2 levels
