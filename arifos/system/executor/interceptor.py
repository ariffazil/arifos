"""
arifos/system/executor/interceptor.py
...
from arifos.agi.kernel import AGINeuralCore as AGIKernel
from arifos.asi.kernel import ASIActionCore as ASIKernel
from arifos.system.apex_prime import APEXPrime, Verdict, FloorCheckResult
