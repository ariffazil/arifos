"""
DEPRECATED: Guards have moved to arifos.core.hypervisor.guards
...
Update your imports:
  OLD: from arifos.core.guards import [guard classes]
  NEW: from arifos.core.hypervisor.guards import [guard classes]
...
warnings.warn(
    "arifos.core.guards is deprecated. "
    "Use arifos.core.hypervisor.guards instead. "
...
from arifos.core.hypervisor.guards import *
