...
def main():
    ...
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Examples:
  python -m arifos.trinity.config_validator
  python -m arifos.trinity.config_validator --config custom/agents.yaml
  python -m arifos.trinity.config_validator --json
