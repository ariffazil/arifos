...
def compute_empathy_score_split(
    ...
    """
    from arifos.enforcement.response_validator import compute_empathy_score
    ...
    if telemetry:
        ...
        from arifos.apex.governance.session_physics import (
...
def validate_response_full(
    ...
    *,
    ...
    from arifos.enforcement.response_validator import (
        _check_amanah_patterns,
        _check_peace_patterns,
        compute_clarity_score,
    )
    from arifos.enforcement.metrics import check_anti_hantu, TRUTH_THRESHOLD
