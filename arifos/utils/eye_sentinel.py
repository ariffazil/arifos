...
This module re-exports from arifos.system.eye for backward compatibility.
New code should import directly from arifos.system.eye.
...
See: arifos.eye for the modular implementation
     canon/030_EYE_SENTINEL_v35Omega.md
"""

# v42: Re-export from eye package (at arifos/system/eye/, not utils/eye/)
