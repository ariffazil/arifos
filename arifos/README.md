...
> **CANONICAL SOURCE OF TRUTH: [`ariffazil/arifOS`](https://github.com/ariffazil/arifOS)**
>
> This repo holds: doctrine, Floors (F1–F13), `AGENTS.md`, `pyproject.toml`, canonical tools, architecture, and canonical index spec.
>
> **Runtime truth (what's running now):** verify the deployed surfaces before claiming health. As checked on **2026-05-19**, `arifosmcp.arif-fazil.com/health` returns **200 with 16 tools** (13 canonical governance + 3 diagnostic/utility). `mcp.arif-fazil.com` is the canonical live endpoint.

```
VERSION:            2026.05.19+16tool
...
READINESS:         100/100 (gateway operational — 16 tools live at mcp.arif-fazil.com)
SEAL:              SEAL_20260519_README_REFRESH
SOURCE_REPO:       https://github.com/ariffazil/arifOS
CANONICAL_INDEX:   arifos://schema

ARCHITECTURE:      13 Canonical Tools + 5 Canonical Resources + 6 Memory Substrates
KERNEL:            Unified rCore (INPUT → ORCHESTRATE → OUTPUT)
MCP_SUBSTRATES:    Time, Filesystem, Git, Memory, Fetch, Everything
NEW_SUBSTRATES:    graphiti-mcp (knowledge graph, port 8000), ml_floors (semantic classifier)
DEPLOYMENT:       VPS Unified Stack (Postgres + Redis + Qdrant + Ollama + Caddy)
...
> Last verified: **2026-05-19** — MCP gateway healthy; 16 tools responding.

### Primary MCP Server

| Endpoint | Status | Purpose |
|---|---|---|
| [mcp.arif-fazil.com/tools](https://mcp.arif-fazil.com/tools) | ✅ LIVE (200) | Public MCP landing page / tool portal |
| [arifosmcp.arif-fazil.com/health](https://arifosmcp.arif-fazil.com/health) | ✅ LIVE (200) | Health endpoint — 16 tools, all floors active |
...
| [mcp.arif-fazil.com/health](https://mcp.arif-fazil.com/health) | ✅ LIVE (200) | Health endpoint serving healthy runtime |
| [mcp.arif-fazil.com/mcp](https://mcp.arif-fazil.com/mcp) | ✅ LIVE (200) | MCP transport healthy from public edge |

### Internal MCP Substrates (VPS)

| Service | Port | Status | Constitutional Enforcement |
|---|---|---|---|
| `mcp_time` | :8001 | Internal | F2 Truth — deterministic epoch anchoring |
| `mcp_filesystem` | :8002 | Internal | F1 Amanah — destructive ops require 888_HOLD |
| `mcp_git` | :8003 | Internal | F11 Authority — commits require ratification |
| `mcp_memory` | :8004 | Internal | F2 Truth, F11 Audit — immutable entity relations |
| `mcp_fetch` | :8005 | Internal | F9 Anti-Hantu — SSRF protection |
| `mcp_everything` | — | Internal | ALL F1–F13 — protocol conformance testing |
...
> **Note:** As of 2026-05-19, the public MCP gateway is fully operational. All endpoints return 200.

```bash
# Current public health check (returns 200 as of 2026-05-19)
curl -i https://mcp.arif-fazil.com/health

# Tool portal (live as of 2026-05-19)
...
## Tool Ecosystem — 16 Live Tools

arifOS exposes **16 live tools** under the FastMCP public surface (13 canonical governance + 3 diagnostic/utility). All use underscore naming (`arifos_init`, `arifos_sense`, etc.).
...
> **As of 2026-04-17:** The public MCP gateway's `/mcp` and `/health` endpoints are returning 502. The `/tools` portal remains live. Check endpoint status before use.
...
|---|---|---|
| **2026.05.19** | 2026-05-19 | README refresh — 16-tool live surface verified; graphiti-mcp and ml_floors substrate noted; A2A bridge healthy |
| **2026.4.17** | 2026-04-17 | Final consolidation — canonical repo aligned; MCP gateway partial degradation noted |
...
*Version: 2026.05.19 · Kernel: ΔΩΨ-ARIF-888 · Seal: SEAL_20260519_README_REFRESH · Repo Status: CANONICAL / Public MCP Status: OPERATIONAL (all endpoints 200 on 2026-05-19)*
