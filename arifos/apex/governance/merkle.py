"""
DEPRECATED: This module has moved to arifos.state.merkle

Merkle tree functionality is now part of the state layer.
This shim will be removed in v47.2 (72 hours after v47.1 release).

Update your imports:
  OLD: from arifos.apex.governance.merkle import MerkleTree
  NEW: from arifos.state.merkle import MerkleTree
...
warnings.warn(
    "arifos.apex.governance.merkle is deprecated. "
    "Use arifos.state.merkle instead. "
...
from arifos.state.merkle import *
