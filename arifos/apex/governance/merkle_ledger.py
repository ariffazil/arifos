...
Update your imports:
  OLD: from arifos.apex.governance.merkle_ledger import MerkleLedger
  NEW: from arifos.state.merkle_ledger import MerkleLedger
...
from arifos.state.merkle_ledger import *
