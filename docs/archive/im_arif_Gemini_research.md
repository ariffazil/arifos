...
- **Execution control / existence gating (strong).**
    ...
    - Adapter (`arifosmcp.transport`) only calls kernel; it never decides, ensuring all cognition is gated at L0.[^11_4][^11_5][^11_1]
...
arifOS exposes a governed MCP surface through arifosmcp.runtime. Every tools/call is evaluated through constitutional gates before execution.
Protocol versioning
