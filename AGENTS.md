# AGENTS - Constitutional Governance v46.1
...
### 111 UNKNOWN: Defined in L2 (✅ IMPLEMENTED)
**Pipeline Stage:** 111 | **Function:** No description available
**Primary Floors:** F1, F2
**Spec:** `L2_PROTOCOLS/v46/111_sense/111_sense.json`

### 222 UNKNOWN: Defined in L2 (✅ IMPLEMENTED)
**Pipeline Stage:** 222 | **Function:** No description available
**Primary Floors:** F3, F4
**Spec:** `L2_PROTOCOLS/v46/222_reflect/222_reflect.json`

### 333 UNKNOWN: Defined in L2 (✅ IMPLEMENTED)
**Pipeline Stage:** 333 | **Function:** No description available
**Primary Floors:** F1, F2, F10
**Spec:** `L2_PROTOCOLS/v46/333_atlas/333_atlas.json`

### 444 ALIGN: Thermodynamic Heat Sink (ASI Safety Damper) (✅ IMPLEMENTED)
**Pipeline Stage:** 444 | **Function:** Safety layer that dissipates cognitive heat (risk/entropy) from AGI (333) before it reaches the Heart (555). Implements the Sabar Protocol.
