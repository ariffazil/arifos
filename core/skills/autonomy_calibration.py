...
if __name__ == "__main__":
    ...
    strict_tool = ToolRiskMetrics(
        tool_name="forge_execute", action_class="ATOMIC",
        current_band="HUMAN_ONLY", total_invocations=50,
        hold_count=20, override_count=6,
        hold_rate=0.40, override_rate=0.30,
    )
    ...
    safe_tool = ToolRiskMetrics(
        tool_name="docker.ps", action_class="OBSERVE",
        current_band="APPROVE_ONLY", total_invocations=200,
        hold_count=0, override_count=0,
        hold_rate=0.0, override_rate=0.0,
    )
    ...
    normal = ToolRiskMetrics(
        tool_name="arif_sense_observe", action_class="OBSERVE",
        current_band="FULL_AUTO", total_invocations=20,
        hold_count=1, override_count=0,
        hold_rate=0.05, override_rate=0.0,
    )
