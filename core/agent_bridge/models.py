...
class AgentTelemetry(BaseModel):
    ...
    agent_id: str = Field(..., description="Canonical agent name: kimi | claude | codex | copilot | aider | continue | gemini")
    ...
    learnings: list[str] = Field(default_factory=list, description="Actionable insights for other agents")
    ...
    metadata: dict[str, Any] = Field(default_factory=dict, description="Extra context (repo, branch, files touched)")
