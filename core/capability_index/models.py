...
class CapabilityRecord(BaseModel):
    ...
    tags: list[str] = Field(default_factory=list, description="Semantic tags, e.g. ['capital', 'liquidity', 'malaysia']")
    epistemic_tag: str = Field(default="CLAIM", description="Evidence quality: CLAIM | PLAUSIBLE | HYPOTHESIS | ESTIMATE")
