...
The W@W Federation is a five-organ governance system that evaluates outputs from domain-specific perspectives.
...
| **@WELL** | Somatic safety | Peace^2 | F5 | SABAR |
| **@RIF** | Epistemic rigor | Delta S, Truth | F2, F4 | VOID |
...
- **Clarity (Delta S_prompt)** - Prompts must gain or maintain clarity
- **Tone Safety (Peace^2, kappa_r)** - Non-inflammatory, empathetic framing
- **Integrity (Amanah)** - No irreversible harm or unethical intent
- **Honesty (C_dark < 0.30)** - No manipulation or coercion

### 4.3 Constitutional Floors

| Floor | Metric | Threshold | Type | Action |
|-------|--------|-----------|------|--------|
| F1 | Amanah | LOCK | Hard | VOID |
| F4 | Delta S_prompt | >= 0.0 | Hard | SABAR |
| F5 | Peace^2_prompt | >= 1.0 | Soft | SABAR |
| F6 | kappa_r_prompt | >= 0.95 | Soft | SABAR |
...
## 7. @WEALTH Organ (Resource Integrity)
...
- Protect resources
- Prevent unethical intent

---

## 8. @GEOX Organ (Physical Feasibility)

### 8.1 Primary Metrics

| Metric | Description |
|--------|-------------|
| E_earth | Physical reality check |
...
## 9. Truth Polarity Classification
