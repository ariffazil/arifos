...
SITES = [
    ...
    {"name": "Theory (arifos.arif-fazil.com)", "url": "https://arifos.arif-fazil.com/", "expected_status": 200},
    {"name": "Apps MCP Hub (arifosmcp.arif-fazil.com)", "url": "https://arifosmcp.arif-fazil.com/", "expected_status": 200},
    {"name": "MCP Endpoint", "url": "https://arifosmcp.arif-fazil.com/mcp", "expected_status": 200},
    {"name": "Dashboard", "url": "https://arifosmcp.arif-fazil.com/dashboard", "expected_status": 200},
    {"name": "Developer Portal", "url": "https://arifosmcp.arif-fazil.com/developer", "expected_status": 200},
    {"name": "LLMs.txt", "url": "https://arifosmcp.arif-fazil.com/llms.txt", "expected_status": 200},
]
    ...
    try:
        ...
        with urllib.request.urlopen(req, timeout=TIMEOUT) as resp:
            ...
            if actual == expected:
                ...
                return {"name": name, "url": url, "status": "DOWN", "code": actual, "error": f"Unexpected status {actual} (expected {expected})"}
