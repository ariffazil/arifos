...
# These ARE implemented - wiring them in from codebase/
try:
    from codebase.engines.agi.atlas import ATLAS, GPV
...
def _step_0_root_key_ignition(session_id: str) -> Dict[str, Any]:
    ...
    try:
        ...
        from codebase.memory.root_key_accessor import verify_genesis_block
