...
from arifos_core.engines.zkpc.receipt_generator import ZKPCReceiptV47, ReceiptGenerator
...
if __name__ == "__main__":
    ...
    from arifos_core.engines.zkpc.receipt_generator import ReceiptGenerator
