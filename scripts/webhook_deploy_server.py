...
"""
import os, sys, time, hashlib, hmac, json, threading
...
ARIFOS_DEPLOY_SCRIPT = os.environ.get("ARIFOS_DEPLOY_SCRIPT", "/root/arifOS/scripts/deploy_arifosmcp.sh")
...
@app.get("/health")
async def health():
    return {"status": "healthy", "service": "arifOS-webhook-deploy", "version": "2026.05.11", "last_deploy": None}
