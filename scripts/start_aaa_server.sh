#!/bin/bash
# Quick start script for AAA MCP Server (Unix/Mac)

set -e

echo "======================================================================"
echo "  AAA MCP Server - Quick Start (Unix/Mac)"
echo "======================================================================"
echo ""
...
if [ ! -d vault_999/CCC/L0_Vault ]; then
    echo "  Creating vault structure..."
    mkdir -p vault_999/CCC/L0_Vault
    mkdir -p vault_999/BBB
    mkdir -p vault_999/CCC/L4_Witness
fi
echo "  OK"

echo ""
echo "[4/4] Starting AAA MCP Server..."
echo "  Press Ctrl+C to stop"
echo ""
python3 arifos_core/mcp/aaa_server.py
