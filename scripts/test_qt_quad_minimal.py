...
def test_calculate_w_ai_quad():
    ...
    # Full chain
    chain = [
        {'thought': 'T1', 'stage': 'Problem Definition', 
         'axioms_used': ['F2'], 'assumptions_challenged': [], 
         'isRevision': False, 'tags': []},
        {'thought': 'T2', 'stage': 'Research', 
         'axioms_used': ['F2', 'F7'], 'assumptions_challenged': ['a1'], 
         'isRevision': False, 'tags': []},
        {'thought': 'T3', 'stage': 'Analysis', 
         'axioms_used': ['F1'], 'assumptions_challenged': [], 
         'isRevision': False, 'tags': []},
        {'thought': 'T4', 'stage': 'Analysis', 
         'axioms_used': ['F9'], 'assumptions_challenged': ['a2', 'a3'], 
         'isRevision': True, 'branchId': 'b1', 'tags': []},
        {'thought': 'T5', 'stage': 'Synthesis', 
         'axioms_used': ['F5'], 'assumptions_challenged': [], 
         'isRevision': False, 'tags': []},
        {'thought': 'T6', 'stage': 'Conclusion', 
         'axioms_used': ['F3', 'F13'], 'assumptions_challenged': ['a4'], 
         'isRevision': False, 'tags': []},
    ]
...
def test_calculate_w_adversarial():
    ...
    chain = [
        ...
        {'thought': 'T2', 'isRevision': True, 'assumptions_challenged': ['a1', 'a2'], 'branchId': 'b1'},
...
def test_build_qt_quad_proof():
    ...
    chain = [
        {'thought': 'T1', 'stage': 'Problem Definition', 
         'axioms_used': ['F2'], 'assumptions_challenged': [], 
         'isRevision': False, 'tags': []},
        {'thought': 'T2', 'stage': 'Analysis', 
         'axioms_used': ['F1'], 'assumptions_challenged': ['a1'], 
         'isRevision': True, 'branchId': 'b1', 'tags': []},
        {'thought': 'T3', 'stage': 'Synthesis', 
         'axioms_used': ['F5'], 'assumptions_challenged': [], 
         'isRevision': False, 
         'tags': ['stakeholder:user|impact:high|psi:0.9|entangled:true']},
        {'thought': 'T4', 'stage': 'Conclusion', 
         'axioms_used': ['F3'], 'assumptions_challenged': [], 
         'isRevision': False, 'tags': []},
    ]
