...
class TestFloorScorer:
    ...
    def test_import(self):
        ...
        from arifos.core.enforcement.trinity_orchestrator import (
            FLOOR_SCORER,
            TrinityOrchestrator,
            grade_text,
            is_safe,
    ...
    def test_safe_text_seals(self):
        ...
        from arifos.core.enforcement.trinity_orchestrator import grade_text
    ...
    def test_is_safe_helper(self):
        ...
        from arifos.core.enforcement.trinity_orchestrator import is_safe
