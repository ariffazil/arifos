...
import pytest
from arifos.integration.waw import (
    OrganSignal,
    OrganVote,
    WAWOrgan,
    WellOrgan,
...
class TestImports:
    ...
    def test_import_base_types(self):
        from arifos.integration.waw import OrganSignal, OrganVote, WAWOrgan
    ...
    def test_import_federation(self):
        from arifos.integration.waw import WAWFederationCore, FederationVerdict
