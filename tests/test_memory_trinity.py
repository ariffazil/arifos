...
class TestMemoryVault:
    ...
    def test_vault_not_found(self):
        ...
        from arifos.mcp.tools.memory_vault import memory_get_vault_sync
...
class TestMemoryPropose:
    ...
    def test_auth_gating_permanent_token_blocked(self):
        ...
        from arifos.mcp.tools.memory_propose import memory_propose_entry_sync
...
class TestMemoryPhoenix:
    ...
    def test_phoenix_list_returns_structure(self):
        ...
        from arifos.mcp.tools.memory_phoenix import memory_list_phoenix_sync
...
class TestMemoryZkpc:
    ...
    def test_zkpc_not_found(self):
        ...
        from arifos.mcp.tools.memory_zkpc import memory_get_zkpc_receipt_sync
