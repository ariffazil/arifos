...
from arifos.enforcement.metrics import (DELTA_S_THRESHOLD,
                                             ...
                                             TRUTH_THRESHOLD)
from arifos.system.runtime_manifest import (DEFAULT_MANIFEST_PATH,
...
class TestV37DefaultEpoch:
    ...
    def test_default_epoch_is_v37_when_env_unset(self):
        ...
        from arifos.system.runtime_manifest import (DEFAULT_EPOCH,
                                                         EPOCH_ENV_VAR,
                                                         get_active_epoch,
                                                         is_legacy_epoch,
                                                         is_v37_epoch)
    ...
    def test_v35_selectable_via_env(self):
        ...
        from arifos.system.runtime_manifest import (EPOCH_ENV_VAR,
                                                         get_active_epoch,
                                                         is_legacy_epoch,
                                                         is_v37_epoch)
    ...
    def test_legacy_epochs_set_contains_v35_and_others(self):
        ...
        from arifos.system.runtime_manifest import LEGACY_EPOCHS
