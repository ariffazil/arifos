...
def test_agentic_telemetry_schema():
    ...
    p = _payload(result)
    t = p.get("telemetry", {})
    required = ["spec_version", "epoch", "qdf", "loops", "tools_used",
                "coverage_score", "conflict_score", "confidence", "verdict",
                "witness", "states_visited"]
...
if __name__ == "__main__":
    test_agentic_mode_dispatches();       print("  PASS: mode_dispatches")
    test_agentic_telemetry_schema();      print("  PASS: telemetry_schema")
    test_agentic_sub_questions_fallback();print("  PASS: sub_questions_fallback")
    test_agentic_search_governance();     print("  PASS: search_governance")
    test_agentic_not_mutating();          print("  PASS: not_mutating")
    test_agentic_evidence_structure();    print("  PASS: evidence_structure")
