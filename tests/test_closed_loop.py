...
def test_reality_bridge():
    ...
    from arifosmcp.provisional.reality import RealityBridge
...
def test_execution_validator():
    ...
    print(
        f"  Execution Validator: OK (W3={result.w3_score:.3f}, integrity={result.verification.integrity_score:.2f})"
    )
    return True
