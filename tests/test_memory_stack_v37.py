...
class TestMemoryContext:
    ...
    def test_create_memory_context(self):
        ...
        from arifos.memory.core.memory_context import create_memory_context
    ...
    def test_env_band_operations(self):
        ...
        from arifos.memory.core.memory_context import EnvBand
    ...
    def test_vault_band_is_frozen(self, sample_constitution: Path):
        ...
        from arifos.memory.core.memory_context import VaultBand
    ...
    def test_active_stream_band_operations(self):
        ...
        from arifos.memory.core.memory_context import ActiveStreamBand
    ...
    def test_validate_memory_context(self):
        ...
        from arifos.memory.core.memory_context import (
            MemoryContext,
            EnvBand,
            VaultBand,
            LedgerBand,
...
class TestScarManager:
    ...
    def test_observe_pattern_creates_witness(self, temp_runtime_dir: Path):
        ...
        from arifos.memory.scars.scar_manager import ScarManager, ScarManagerConfig
    ...
    def test_compute_floor_pressure(self, temp_runtime_dir: Path):
        ...
        from arifos.memory.scars.scar_manager import (
            ScarManager,
            ScarManagerConfig,
            SEVERITY_WEIGHTS,
        )
...
class TestCoolingLedgerV37:
    ...
    def test_append_v37_creates_hash_chain(self, temp_runtime_dir: Path):
        ...
        from arifos.memory.ledger.cooling_ledger import CoolingLedgerV37, LedgerConfigV37
...
class TestEurekaReceiptManager:
    ...
    def test_generate_receipt_for_seal(self, temp_runtime_dir: Path):
        ...
        from arifos.memory.eureka.eureka_receipt import (
    ...
    def test_no_receipt_for_void(self, temp_runtime_dir: Path):
        ...
        from arifos.memory.eureka.eureka_receipt import generate_eureka_receipt
...
class TestPhoenix72Controller:
    ...
    def phoenix_setup(self, temp_runtime_dir: Path, sample_constitution: Path):
        ...
        from arifos.memory.scars.scar_manager import ScarManager, ScarManagerConfig
        from arifos.memory.vault.vault_manager import (
            VaultManager,
            VaultManagerConfig,
            SafetyConstraints,
        )
        from arifos.memory.ledger.cooling_ledger import CoolingLedgerV37, LedgerConfigV37
        from arifos.memory.phoenix.phoenix72_controller import (
            Phoenix72Controller,
            Phoenix72Config,
        )
    ...
    def test_cooldown_enforcement(self, temp_runtime_dir: Path, sample_constitution: Path):
        ...
        from arifos.memory.scars.scar_manager import ScarManager, ScarManagerConfig
        from arifos.memory.vault.vault_manager import VaultManager, VaultManagerConfig
        from arifos.memory.ledger.cooling_ledger import CoolingLedgerV37, LedgerConfigV37
        from arifos.memory.phoenix.phoenix72_controller import (
            Phoenix72Controller,
            Phoenix72Config,
        )
        from arifos.memory.vault.vault_manager import SafetyConstraints
...
class TestRuntimeManifest:
    ...
    def test_normalize_epoch(self):
        ...
        from arifos.system.runtime_manifest import normalize_epoch
        import pytest
    ...
    def test_is_v37_epoch(self):
        ...
        from arifos.system.runtime_manifest import is_v37_epoch, set_active_epoch
