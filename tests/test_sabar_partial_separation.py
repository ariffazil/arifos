...
import pytest
from arifos.memory.core.policy import VERDICT_BAND_ROUTING, MemoryWritePolicy
from arifos.memory.core.bands import PendingBand, PhoenixCandidatesBand, BandName
...
class TestSABARPartialSeparation:
    ...
    def test_pending_band_properties(self):
        ...
        from arifos.memory.core.bands import BAND_PROPERTIES
