...
# 6. Verify deployment
curl -I https://mcp.arif-fazil.com/dashboard/
```
...
| URL | File | Purpose |
|-----|------|---------|
| `https://mcp.arif-fazil.com/dashboard/` | `index.html` | Entry point (redirects to v2) |
| `https://mcp.arif-fazil.com/dashboard/dashboard-v2.html` | `dashboard-v2.html` | Improved dashboard |
| `https://mcp.arif-fazil.com/dashboard/dashboard.html` | `dashboard.html` | Legacy (kept for reference) |
...
- Test: `curl https://mcp.arif-fazil.com/api/status`
...
- [ ] Live URL accessible: `https://mcp.arif-fazil.com/dashboard/`
