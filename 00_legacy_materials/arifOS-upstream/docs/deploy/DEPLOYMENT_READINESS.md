...
- Runtime entrypoint: `uvicorn arifosmcp.runtime.server:app --host 0.0.0.0 --port 8080`
- Public tool contract: 13 tools / 11 prompts / 3 resources from the packaged NEXT HORIZON surface
...
- discovery reports the 13-tool canonical public contract
- `tools/list` returns the 13-tool public contract
