...
> ⚠️ **LEGACY ALIAS**: `arifosmcp.arif-fazil.com` is no longer the canonical public host. Use **`mcp.arif-fazil.com`** for the live public MCP surface (**13 tools / 11 prompts / 3 resources**).
>
